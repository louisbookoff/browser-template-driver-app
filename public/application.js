...
var config = {
  apiOrigins: {
    production: 'https://salty-everglades-61557.herokuapp.com/'
...
var onCreateTrips = function onCreateTrips(event) {
  event.preventDefault();
  // pass event.target to getFormFields to create a data object
  var data = getFormFields(event.target);

  // pass data to createTrips function
  api.createTrips(data).then(ui.createTripSuccess).catch(ui.createTripFailure);
};

var onGetTrips = function onGetTrips(event) {
  event.preventDefault();
  api.getTrips(event).then(ui.getTripsSuccess).catch(ui.getTripsFailure);
};
...
var onDeleteTrip = function onDeleteTrip(event) {
  ...
  api.deleteTrip(id).then(ui.deleteTripSuccess).catch(ui.deleteTripFailure);
  // console.log('data is ', data)
};
...
var createTrips = function createTrips(data) {
  return $.ajax({
...
var store = __webpack_require__(5);
var showHandlebars = __webpack_require__(17);
...
var getTripsSuccess = function getTripsSuccess(data) {
  // console.log(data)
  var showTripsHtml = showHandlebars({ trips: data.trips });
  $('#content').html(showTripsHtml);
  var elements = data.trips;
...
var getTripsFailure = function getTripsFailure(data) {
...
module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
  ...
  return "      <!-- "
    ...
    + " </td>\n\n    <!-- <div> -->\n    <td> "
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.pick_up_location : stack1), depth0))
    + " </td>\n    <td> "
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.drop_off_location : stack1), depth0))
    + " </td>\n    <!-- <td> "
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.user_id : stack1), depth0))
    + " </td> -->\n    <td> "
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.passengers : stack1), depth0))
    + " </td>\n    <td> "
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.trip_start : stack1), depth0))
    + " </td>\n    <td> "
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.trip_end : stack1), depth0))
    + " </td>\n\n    <!-- </div> -->\n\n    <td> <button data-id=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
    + "\" class=\"btn btn-default delete\">Delete Trip</button> </td>\n    <!-- <td>    <button data-id=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
    + "\" type=\"submit\" class=\"btn btn-default\">Submit</button> </td>  -->\n\n    </tr>\n  </tbody>\n";
},"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data,blockParams) {
    var stack1;

  return "<table style=\"width:100%\" class=\"table content table-hover\">\n  <thead class=\"thead-dark\">\n    <th align=\"center\"> Trip ID </th>\n    <th align=\"center\"> Pickup Location </th>\n    <th align=\"center\"> Drop-Off </th>\n    <th align=\"center\"> Passengers </th>\n    <th align=\"center\"> Trip Start </th>\n    <th align=\"center\"> Trip End </th>\n    <th align=\"center\"> Delete Trips</th>\n\n"
    + ((stack1 = helpers.each.call(depth0 != null ? depth0 : (container.nullContext || {}),(depth0 != null ? depth0.trips : depth0),{"name":"each","hash":{},"fn":container.program(1, data, 1, blockParams),"inverse":container.noop,"data":data,"blockParams":blockParams})) != null ? stack1 : "")
    + "</table>\n";
...
module.exports = (Handlebars["default"] || Handlebars).template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
    return "<br>I'm a partial that is included in every <big><i>books</i></big> iteration\n";
},"useData":true});
